...
import { Plus, X, AlertCircle, Maximize2, Minimize2 } from 'lucide-react'
...
export default function VehicleInspectionDiagram() {
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className={`transition-all duration-300 ${isFullScreen ? 'fixed inset-0 z-50 bg-white p-4 flex flex-col justify-center' : 'flex-1'}`}>
                <div className={`bg-slate-50 border border-slate-200 rounded-xl relative select-none ${isFullScreen ? 'h-full flex flex-col' : 'p-4 md:p-8'}`}>
                    ...
                    <div className={`w-full overflow-x-auto ${isFullScreen ? 'flex-1 flex items-center bg-slate-100/50 rounded-lg overflow-y-auto' : 'pb-4'}`}>
                        <div
                ...
                {/* Legend */}
                <div className={`mt-4 flex gap-4 justify-center ${isFullScreen ? 'hidden' : ''}`}>
