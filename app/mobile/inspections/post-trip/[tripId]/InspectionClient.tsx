...
export default function InspectionClient() {
    ...
    const [checklist, setChecklist] = useState([
        { id: 1, item: "Cleanliness (interior & exterior)", status: null as boolean | null, photo: null as string | null },
        { id: 2, item: "New Damage / Scratches", status: null as boolean | null, photo: null as string | null },
        { id: 3, item: "Fuel Level (recorded)", status: null as boolean | null, photo: null as string | null },
        { id: 4, item: "Tires (after trip condition)", status: null as boolean | null, photo: null as string | null },
        { id: 5, item: "Windows & Lights (integrity)", status: null as boolean | null, photo: null as string | null },
        { id: 6, item: "Equipment Returned (Jack, Spare, Tools)", status: null as boolean | null, photo: null as string | null },
        { id: 7, item: "Personal Belongings Removed", status: null as boolean | null, photo: null as string | null },
        { id: 8, item: "Logbook Updated", status: null as boolean | null, photo: null as string | null },
    ])
        ...
        <div className="pb-20">
            <div className="p-4 space-y-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Post-Trip Inspection</h1>
                        <p className="text-sm text-muted-foreground">Verify vehicle condition after use</p>
                    </div>
                </div>
                ...
                <div className="bg-card border rounded-lg p-4">
                    ...
                    <div className="flex items-center gap-4 mt-3 text-xs">
                        <div className="flex items-center gap-1">
                            ...
                            <span>{passedItems} Good</span>
                        </div>
                        <div className="flex items-center gap-1">
                            <XCircle className="w-4 h-4 text-red-600" />
                            <span>{failedItems} Issues</span>
                        </div>
                    </div>
                </div>
                ...
                {failedItems > 0 && (
                    <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
                        ...
                        <div>
                            <p className="font-semibold text-red-900">Issues Reported</p>
                            <p className="text-sm text-red-700">
                                You have marked {failedItems} item(s) as failed/damaged. This will be flagged for maintenance.
                            </p>
                        </div>
                    </div>
                )}
